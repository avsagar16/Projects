...
public class Engine implements Serializable {
    ...
    public TETile appearanceMenu() {
        ...
        StdDraw.text(this.WIDTH / 2, place * 5, "Would you like to play with a different appearance?");
    ...
    public String nameMenu() {
        ...
        StdDraw.text(this.WIDTH / 2, place, "Caution: Clicking the delete key will cause the program to exit so be careful!");
        String content = "";
        int count = 1;
        while (count > 0) {
            if (StdDraw.hasNextKeyTyped()) {
